...
/*
 * Copyright (c) 2023 Clovis Corde (Kickmaker)
 *
 ...
 * @return zero(0) or negative error code.
 */
typedef int (*delta_seek_t)(delta_memory_struct_t *arg_p,
 ...
 * @return zero(0) or negative error code.
 */
int delta_apply_patch_init(struct delta_api_t *self_p,
                           delta_read_t        read,
                           delta_write_t       write,
                           delta_seek_t        seek,
                           delta_mem_erase_t   erase);
