 ...
 */
#ifndef ZEPHYR_INCLUDE_ZEPHYR_DELTA_DELTA_ALGORITHM_H_
#define ZEPHYR_INCLUDE_ZEPHYR_DELTA_DELTA_ALGORITHM_H_
...
#endif /* ZEPHYR_INCLUDE_ZEPHYR_DELTA_DELTA_ALGORITHM_H_ */
